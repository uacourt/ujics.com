...
\begin{titlepage}
  ...
  {\HUGE  \textbf{X. Кабінет} \par} \vspace{2.5cm}
  {\LARGE \textbf{X-1. Заяви} \par}
  {\LARGE \textbf{X-2. Листи} \par}
  {\LARGE \textbf{X-3. Звернення} \par}
  {\LARGE \textbf{X-4. Довіреності} \par}
  {\LARGE \textbf{X-5. Виконавчі документи} \par}
  {\LARGE \textbf{X-6. Провадження} \par}
  {\LARGE \textbf{X-7. Судові рішення} \par}
  \vspace{2.5cm}
  \vfill
...
\section{Звернення}
\section{Довіреності}
\section{Виконавчі документи}
\section{Провадження}
\section{Судові рішення}
